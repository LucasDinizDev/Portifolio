    ...
    <S.Section id="aboutMe">
      <div className="centralizer">
        ...
        <S.AboutMeContainer>
          <div>
            <p>
              Meu nome é Lucas Diniz e eu sou um apaixonado por tecnologia que
              decidiu trilhar o caminho da programação. Trabalhei com projetos
              envolvendo gestão educacional, API's e banco de dados.
            </p>
            <br />
            <p>
              Atualmente estou cursando ciencias da computação e focando no
